...
Once you have edited your template and code you can use the following command lines to deploy your application from the command line (these examples assume the project name is *exif.viewer*):
...
Execute unit tests
```
    cd "exif.viewer/test/exif.viewer.Tests"
    dotnet test
```

Deploy application
```
    cd "exif.viewer/src/exif.viewer"
